  ...
  return (
    <ErrorBoundary>
      <div className="relative min-h-screen overflow-x-hidden bg-transparent text-[var(--mono-text)]">
        ...
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:fixed focus:left-4 focus:top-4 focus:z-[9999] focus:border focus:border-[var(--mono-cyan)] focus:bg-[var(--mono-surface)] focus:px-4 focus:py-2 focus:text-sm focus:text-[var(--mono-cyan)]"
        >
