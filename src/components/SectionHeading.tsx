...
export default function SectionHeading({ title, subtitle }: SectionHeadingProps) {
  return (
    <motion.div
      className="mb-6 sm:mb-10 w-full max-w-5xl"
      initial="hidden"
      whileInView="visible"
    ...
    >
      ...
      <motion.h2 className="mt-3 sm:mt-5 text-3xl font-extrabold leading-tight text-white sm:text-4xl lg:text-5xl" variants={fadeUp}>
        {title}
      </motion.h2>
