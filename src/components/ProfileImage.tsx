...
export default function ProfileImage({
  ...
  return (
    <motion.div
      className="relative mx-auto w-full max-w-[14rem] overflow-hidden rounded-full border border-cyan-400/12 bg-slate-950/10 shadow-[0_20px_60px_rgba(8,15,31,0.35)] sm:max-w-[18rem] md:max-w-[20rem] lg:max-w-[22rem]"
