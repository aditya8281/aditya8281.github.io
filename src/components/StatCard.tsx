...
export default function StatCard({ label, value, hint, onClick }: Props) {
  ...
  return (
    <motion.div
      ...
      className={`glass-card flex flex-col gap-3 p-4 min-w-0 transition-colors duration-300 ${onClick ? 'cursor-pointer hover:border-cyan-300/35 hover:bg-cyan-400/5 focus-visible:ring-2 focus-visible:ring-cyan-400/50 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-950' : ''}`}
    >
