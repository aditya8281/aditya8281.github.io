  ...
  return (
    <footer className="py-10 border-t border-white/6">
      <div className="app-container flex flex-col gap-6 text-center sm:flex-row sm:items-center sm:justify-between sm:text-left">
        <div>
          <p className="text-sm text-slate-300">Vision, edge AI, RL, and systems — built and deployed.</p>
          <p className="mt-2 text-xs text-slate-500">&copy; {new Date().getFullYear()} Aditya Rathod</p>
        </div>
        ...
        <div className="flex items-center justify-center gap-3 sm:justify-end">
          <a
            ...
            aria-label="GitHub"
            className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-white/8 bg-white/3 text-slate-300 transition hover:border-cyan-400/25 hover:text-cyan-200"
          >
