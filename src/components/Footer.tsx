  ...
  return (
    <footer className="border-t border-[var(--mono-surface-3)] py-8">
      <div className="app-container flex flex-col gap-6 text-center sm:flex-row sm:items-center sm:justify-between sm:text-left">
        <div>
          <p className="text-sm text-[var(--mono-text-dim)]">Backend, systems, vision — built and shipped from IIT Jodhpur.</p>
        ...
        <div className="flex items-center justify-center gap-3 sm:justify-end">
          <a
            ...
            aria-label="GitHub"
            className="inline-flex h-9 w-9 items-center justify-center border border-[var(--mono-surface-3)] text-[var(--mono-comment)] transition hover:border-[var(--mono-cyan)] hover:text-[var(--mono-cyan)]"
          >
