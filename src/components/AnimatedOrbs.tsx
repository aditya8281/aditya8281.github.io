  ...
  if (prefersReducedMotion) {
    return (
      <div className="relative w-full h-full overflow-hidden">
        <div className="absolute left-3 top-3 h-36 w-36 sm:h-40 sm:w-40 rounded-full bg-gradient-to-br from-cyan-400/30 to-indigo-400/20 blur-3xl opacity-40" />
        <div className="absolute right-3 top-20 h-24 w-24 sm:h-28 sm:w-28 rounded-full bg-gradient-to-br from-blue-400/24 to-cyan-300/12 blur-2xl opacity-40" />
